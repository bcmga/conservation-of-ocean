...
FishManager.prototype.init = function() {
	var self = this;
	self.setFishRule = 
		[{duration:30, period:1, speedInSecond:{min:2,max:3}}
		,{duration:20, period:1.5, speedInSecond:{min:3,max:5}}
		,{duration:-1, period:1.5, speedInSecond:{min:4,max:7}}
	...
	self.fishType = 
		[{
			...
			,images:[/*{name:"l_1", width:336, height:84, frameNumber:4}
					...
					{name:"l_3", width:250, height:43, frameNumber:4}
			...
			stype:"p"
			,images:[{name:"p_1", width:500, height:100, frameNumber:4}
					,{name:"p_2", width:500, height:150, frameNumber:4}]
		},{
			stype:"t"
			,images:[{name:"t_1", width:260, height:65, frameNumber:4}
					/*,{name:"t_2", width:500, height:100, frameNumber:4}*/
					,{name:"t_3", width:310, height:53, frameNumber:4}
			        ,{name:"t_4", width:300, height:75, frameNumber:4}
					,{name:"t_5", width:250, height:76, frameNumber:4}]
					/*,{name:"t_6", width:500, height:150, frameNumber:4}*/
		}];
...
FishManager.prototype.setFish = function() {
	...
	options.motion = {
		...
		,phase: Util.randomInRange(350, 550)
