...
var GAME_FPS = 30;
init(1000/GAME_FPS, "gamediv", 400, 600, main);
var dataList;
var stageLayer;
var mySoundPlayer;
var gScore = 0;
...
,{name : "t_1",path : "style/img_d/t_1.png"}
,{name : "p_1",path : "style/img_d/p_1.png"}
,{name : "t_3",path : "style/img_d/t_3.png"}
,{name : "t_4",path : "style/img_d/t_4.png"}
,{name : "t_5",path : "style/img_d/t_5.png"}
,{name : "p_2",path : "style/img_d/p_2.png"}
...
,{name : "background",path : "script/beijing.html"}
